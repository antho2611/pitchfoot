...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      listings: {
        Row: {
          availability_required: Database["public"]["Enums"]["availability_status"] | null;
          championship: string | null;
          city: string | null;
          club_id: string;
          created_at: string;
    ...
    Enums: {
      ...
      availability_status: "recherche_club" | "immediate" | "fin_saison" | "essai" | "ouvert";
      ...
      subscription_status: "active" | "trialing" | "canceled" | "expired" | "pending";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
